...
ef_2000 <- ef_2000 %>% 
  gather(key = type, value = emissions, - industry) %>% 
  mutate(year= 2000)
...
### Changes in emissions per contaminant type and industry

```{r Changes in emissions per contaminant type and industry, echo=FALSE}
